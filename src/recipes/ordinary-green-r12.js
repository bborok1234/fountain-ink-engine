...
export const ORDINARY_GREEN_RECIPE_R12 = freezeInkRecipe({
  id: "ordinary-green", revision: 12,
  ...
  direct: {
    ...
    optical: {
      ...
      redBase: 18, redWetGain: 48, greenBase: 74, greenWetGain: 64, greenDensityLoss: 18,
      blueBase: 52, blueWetGain: 52, blueDensityLoss: 16, alphaGain: 1.08, maximumAlpha: 0.96,
    },
  },
  optical: {
    densityColorCurve: [
