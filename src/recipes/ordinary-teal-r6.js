...
export const ORDINARY_TEAL_RECIPE_R6 = freezeInkRecipe({
  id: "ordinary-teal", revision: 6,
  ...
  direct: {
    ...
    optical: {
      ...
      redBase: 18, redWetGain: 45, greenBase: 83, greenWetGain: 62, greenDensityLoss: 20,
      blueBase: 86, blueWetGain: 58, blueDensityLoss: 18, alphaGain: 1.08, maximumAlpha: 0.96,
    },
  },
  optical: {
    densityColorCurve: [
