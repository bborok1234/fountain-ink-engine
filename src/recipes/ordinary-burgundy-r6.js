...
export const ORDINARY_BURGUNDY_RECIPE_R6 = freezeInkRecipe({
  id: "ordinary-burgundy", revision: 6,
  engineModelVersion: "ordinary-js-r13", recipeSchemaVersion: 6,
  contact: { catalogId: "fountain-nib-catalog-r2" },
  ...
  direct: {
    ...
    optical: {
      ...
      redBase: 76, redWetGain: 50, greenBase: 43, greenWetGain: 48, greenDensityLoss: 18,
      blueBase: 58, blueWetGain: 52, blueDensityLoss: 18, alphaGain: 1.08, maximumAlpha: 0.96,
    },
  },
  optical: {
    densityColorCurve: [
