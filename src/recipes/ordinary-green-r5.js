...
// Revision 5 preserves every authored coefficient from revision 4. The model
// change transports raw signed glyph Density through positive Surface pigment
// mass; it does not add or retune a recipe control.
export const ORDINARY_GREEN_RECIPE_R5 = freezeInkRecipe({
  id: "ordinary-green",
  revision: 5,
  engineModelVersion: "ordinary-js-r6",
