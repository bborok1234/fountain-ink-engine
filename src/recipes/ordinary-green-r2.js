...
// Revision 2 preserves every authored material coefficient from revision 1.
// Only its engine-model identity changes because r3 separates glyph contact
// geometry from the runtime flow axis.
export const ORDINARY_GREEN_RECIPE_R2 = freezeInkRecipe({
  id: "ordinary-green",
  revision: 2,
  engineModelVersion: "ordinary-js-r3",
